# -*- coding: utf-8 -*-
"""Q2 of hw12_domain_adaptation_VGG.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1OR45iePUWaFYdAPwcyeE3A6ZeYEdiZsu
...
for epoch in range(200):
    ...
    scheduler_F.step()
    scheduler_C.step()
    torch.save(feature_extractor.state_dict(), f'extractor_model_Q2.bin')
    torch.save(label_predictor.state_dict(), f'predictor_model_Q2.bin')
...
#df.to_csv('DaNN_submission_vgg_all.csv',index=False)
