# -*- coding: utf-8 -*-
"""
Created on Fri Jun  5 21:27:17 2020
...
feature_extractor.load_state_dict(torch.load("extractor_model_Q2.bin"))
#summary(feature_extractor, (1, 32, 32))
label_predictor = LabelPredictor().cuda()
label_predictor.load_state_dict(torch.load('predictor_model_Q2.bin'))
...
import numpy as np
np.save('feature_extract_Q2.npy',np.array(feature_extract))
np.save('answer_Q2.npy',np.array(answer))
